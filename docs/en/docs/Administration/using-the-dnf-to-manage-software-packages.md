...
- Configuring the /etc/dnf/dnf.conf file
    ...
    >![](./public_sys-resources/icon-note.gif) **NOTE:**
    >openEuler provides an online image source at  [https://repo.openeuler.org/](https://repo.openeuler.org/). For example, if the openEuler 21.03 version is aarch64, the  **baseurl**  can be set to  [https://archives.openeuler.openatom.cn/openEuler-21.03/OS/aarch64/](https://archives.openeuler.openatom.cn/openEuler-21.03/OS/aarch64/).  
