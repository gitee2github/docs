...
This section describes how to build an RPM software package on a local PC or using OBS. For details, see  [https://gitee.com/openeuler/community/blob/master/en/contributors/packaging.md](https://gitee.com/openeuler/community/blob/master/en/contributors/packaging.md).
<!-- TOC -->
