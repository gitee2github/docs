...
For details about how to install the openEuler OS, see the \[*openEuler 21.09 Installation Guide*\](./../Installation/Installation.html ). On the  **SOFTWARE SELECTION**  page, select  **Development Tools**  in the  **Add-Ons for Selected Environment**  area.
...
1. Download the ISO release package.
   ...
   - Download an ISO image using a cross-platform file transfer tool.
     ...
     4. Select the version to be downloaded, for example, openEuler 21.09. Then, click  **openEuler-21.09**. The download list is displayed.
   ...
   - Run the  **wget**  command to download the ISO image.
     ...
     10. Run the  **wget**  command to remotely download the release package and verification file. In the command,  **ipaddriso**  and  **ipaddrisosum**  are the **openEuler-21.09-aarch64-dvd.iso** and **openEuler-21.09-aarch64-dvd.iso.sha256sum** files.
