...
2.  Click **Download** > **Software Packages** to open the download page.

3.  Find the card for **openEuler 21.09**.

4.  Click **Get ISO** to open the openEuler 21.09 version download list.
