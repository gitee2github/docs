...
-   [Installation Guide]({{< relref "./docs/Installation/Installation.md" >}})
    -   [Installation on Servers]({{< relref "./docs/Installation/install-server.md" >}})
        ...
        -   [Installation UKUI]({{< relref "./docs/Installation/install-UKUI.md" >}})
...
-   [StratoVirt Virtualization User Guide]({{< relref "./docs/StratoVirt/StratoVirt_guidence.md" >}})
    ...
    -   [Querying VM Information]({{< relref "./docs/StratoVirt/Query_VM_information.md" >}})    
    -   [Managing the VM Lifecycle]({{< relref "./docs/StratoVirt/Manage_life_cycle.md" >}})
    -   [Managing VM resources]({{< relref "./docs/StratoVirt/Manage_resource.md" >}})    
