...
-   [Administrator Guide]({{< relref "./docs/Administration/administration.md" >}})
    ...
    -   [KAE Usage]({{< relref "./docs/Administration/using-the-kae.md" >}})
...
-   [StratoVirt Virtualization User Guide]({{< relref "./docs/StratoVirt/StratoVirt_guidence.md" >}})
    ...
    -   [Best Practices]({{< relref "./docs/StratoVirt/Best_practices.md" >}})    
...
-   [Third-Party Software Porting Guide]({{< relref "./docs/thirdparty_migration/thidrparty.md" >}})
    -   [OpenStack Installation Guide]({{< relref "./docs/thirdparty_migration/openstack.md" >}})
        -   [OpenStack Queens Deployment Guide]({{< relref "./docs/thirdparty_migration/OpenStack-queens.md" >}})
        -   [OpenStack Rocky Deployment Guide]({{< relref "./docs/thirdparty_migration/OpenStack-rocky.md" >}})
        -   [OpenStack Train Deployment Guide]({{< relref "./docs/thirdparty_migration/openstack-train.md" >}})
    ...
    -   [HA User Guide]({{< relref "./docs/desktop/ha.md" >}})
        -   [Deploying HA]({{< relref "./docs/desktop/installing-and-deploying-HA.md" >}})
        -   [HA Usage Examples]({{< relref "./docs/desktop/ha-usage-examples.md" >}})
