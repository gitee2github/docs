...
-   直接配置/etc/dnf/dnf.conf文件中的“repository”部分
    ...
    >![](./public_sys-resources/icon-note.gif) **说明：**   
    >openEuler提供在线的镜像源，地址：[https://repo.openeuler.org/](https://repo.openeuler.org/)。以 openEuler 21.03的aarch64版本为例，baseurl可配置为[https://archives.openeuler.openatom.cn/openEuler-21.03/OS/aarch64/](https://archives.openeuler.openatom.cn/openEuler-21.03/OS/aarch64/)。  
