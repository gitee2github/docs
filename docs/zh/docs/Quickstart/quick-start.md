...
本文档以TaiShan 200服务器上安装openEuler 20.03-LTS-SP2为例，旨在指导用户快速地安装和使用openEuler操作系统，更详细的安装要求和安装方法请参考《[openEuler 20.03-LTS-SP2 安装指南](./../Installation/installation.html)》。
<!-- TOC -->
...
4.  单击“openEuler-20.03-LTS-SP2”，进入openEuler 20.03-LTS-SP2版本下载列表。
5.  单击“ISO”，进入ISO下载列表。
...
6.  根据实际待安装环境的架构选择需要下载的openEuler的发布包和校验文件。
    -   若为AArch64架构。
        1.  单击“aarch64”。
        2.  单击“openEuler-20.03-LTS-SP2-aarch64-dvd.iso”，将openEuler发布包下载到本地。
        3.  单击“openEuler-20.03-LTS-SP2-aarch64-dvd.iso.sha256sum”，将openEuler校验文件下载到本地。

    -   若为x86\_64架构。
        1.  单击“x86\_64”。
        2.  单击“openEuler-20.03-LTS-SP2-x86\_64-dvd.iso”，将openEuler发布包下载到本地。
        3.  单击“openEuler-20.03-LTS-SP2-x86\_64-dvd.iso.sha256sum”，将openEuler校验文件下载到本地。
...
8.  设备重启后进入到openEuler操作系统安装引导界面，如[图5](#fig1648754873314)所示。
    ...
    >-   如果60秒内未按任何键，系统将从默认选项“Test this media & install openEuler 20.03-LTS-SP2”自动进入安装界面。  
...
9.  在安装引导界面，按“Enter”，进入默认选项“Test this media & install openEuler 20.03-LTS-SP2”的图形化安装界面。
...
系统安装完成并重启后直接进入系统命令行登录界面，输入安装过程中设置的用户和密码，进入openEuler操作系统，查看如下系统信息。若需要进行系统管理和配置操作，请参考《[openEuler 20.03-LTS-SP2 管理员指南](https://openeuler.org/zh/docs/20.03_LTS_SP2/docs/Administration/administration.html)》。
-   查看系统信息，命令如下：
