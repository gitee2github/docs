...
4.  使用dd命令将ISO安装镜像直接写入USB盘：
    ...
    例如：如果该ISO镜像文件位于 /home/testuser/Downloads/openEuler-20.03-LTS-SP2-aarch64-dvd.iso，同时探测到的设备名称为sdb，则该命令如下：
...
各步骤详细的操作请参考《[openEuler 20.03 LTS SP2 虚拟化用户指南](./../Virtualization/virtualization.html)》。
