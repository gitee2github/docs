...
openEuler发布件包括[ISO发布包](http://repo.openeuler.org/openEuler-21.03/ISO/)、[虚拟机镜像](http://repo.openeuler.org/openEuler-21.03/virtual_machine_img/)、[容器镜像](http://repo.openeuler.org/openEuler-21.03/docker_img/)和[repo源](http://repo.openeuler.org/openEuler-21.03/)。ISO发布包请参见[表1](#table8396719144315)。容器镜像清单参见[表3](#table1276911538154)。repo源方便在线使用，repo源目录请参见[表4](#table953512211576)。
