...
openEuler发布件包括[ISO发布包](https://archives.openeuler.openatom.cn/openEuler-21.09/ISO/)、[虚拟机镜像](https://archives.openeuler.openatom.cn/openEuler-21.09/virtual_machine_img/)、[容器镜像](https://archives.openeuler.openatom.cn/openEuler-21.09/docker_img/)、[边缘镜像](https://archives.openeuler.openatom.cn/openEuler-21.09/edge_img/)、[嵌入式镜像](https://archives.openeuler.openatom.cn/openEuler-21.09/embedded_img/)和[repo源](https://archives.openeuler.openatom.cn/openEuler-21.09/)。ISO发布包请参见[表1](#table8396719144315)。容器镜像清单参见[表3](#table1276911538154)。边缘镜像清单参见[表4](#table1276911538156)。嵌入式镜像清单参见[表5](#table1276911538158)。repo源方便在线使用，repo源目录请参见[表6](#table953512211576)。
...
<tbody><tr id="row739615199431"><td class="cellrowborder" valign="top" width="38.53%" headers="mcps1.2.3.1.1 "><p id="p16396111912430"><a name="p16396111912430"></a><a name="p16396111912430"></a>openEuler-21.09-aarch64-dvd.iso</p>
</td>
...
<tr id="row83961519184313"><td class="cellrowborder" valign="top" width="38.53%" headers="mcps1.2.3.1.1 "><p id="p153964194439"><a name="p153964194439"></a><a name="p153964194439"></a>openEuler-21.09-everything-aarch64-dvd.iso</p>
</td>
...
<tr id="row83968192435"><td class="cellrowborder" valign="top" width="38.53%" headers="mcps1.2.3.1.1 "><p id="p19396319184313"><a name="p19396319184313"></a><a name="p19396319184313"></a>openEuler-21.09-debuginfo-aarch64-dvd.iso</p>
</td>
...
<tr id="row521955165312"><td class="cellrowborder" valign="top" width="38.53%" headers="mcps1.2.3.1.1 "><p id="p92191359537"><a name="p92191359537"></a><a name="p92191359537"></a>openEuler-21.09-x86_64-dvd.iso</p>
</td>
...
<tr id="row1964171015310"><td class="cellrowborder" valign="top" width="38.53%" headers="mcps1.2.3.1.1 "><p id="p3964710125311"><a name="p3964710125311"></a><a name="p3964710125311"></a>openEuler-21.09-everything-x86_64-dvd.iso</p>
</td>
...
<tr id="row342917865317"><td class="cellrowborder" valign="top" width="38.53%" headers="mcps1.2.3.1.1 "><p id="p242914815315"><a name="p242914815315"></a><a name="p242914815315"></a>openEuler-21.09-debuginfo-x86_64-dvd.iso</p>
</td>
...
<tr id="row34221536125311"><td class="cellrowborder" valign="top" width="38.53%" headers="mcps1.2.3.1.1 "><p id="p13423336175314"><a name="p13423336175314"></a><a name="p13423336175314"></a>openEuler-21.09-source-dvd.iso</p>
</td>
...
<tbody><tr id="row1277035311157"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p17686637201813"><a name="p17686637201813"></a><a name="p17686637201813"></a>open<span id="ph11656938181410"><a name="ph11656938181410"></a><a name="ph11656938181410"></a>E</span>uler-21.09-edge-aarch64-dvd.iso</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p3770165314159"><a name="p3770165314159"></a><a name="p3770165314159"></a>A<span id="ph61191628111518"><a name="ph61191628111518"></a><a name="ph61191628111518"></a>A</span>rch64架构下openEuler边缘镜像</p>
</td>
</tr>
<tr id="row1277055310150"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p2686337111816"><a name="p2686337111816"></a><a name="p2686337111816"></a>open<span id="ph21198416145"><a name="ph21198416145"></a><a name="ph21198416145"></a>E</span>uler-21.09-edge-x86_64-dvd.iso</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p9770135311518"><a name="p9770135311518"></a><a name="p9770135311518"></a>x86_64架构下openEuler容器镜像</p>
</td>
</tr>
...
<tbody><tr id="row1277035311157"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p17686637201813"><a name="p17686637201813"></a><a name="p17686637201813"></a>qemu-aarch64/zImage</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p3770165314159"><a name="p3770165314159"></a><a name="p3770165314159"></a>aarch64架构下支持qemu的内核镜像</p>
</td>
</tr>
<tr id="row1277055310150"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p2686337111816"><a name="p2686337111816"></a><a name="p2686337111816"></a>qemu-aarch64/initrd_tiny</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p9770135311518"><a name="p9770135311518"></a><a name="p9770135311518"></a>aarch64架构下极简文件系统</p>
</td>
</tr>
<tr id="row1277055310150"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p2686337111816"><a name="p2686337111816"></a><a name="p2686337111816"></a>qemu-aarch64/initrd</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p9770135311518"><a name="p9770135311518"></a><a name="p9770135311518"></a>aarch64架构下支持安全和容器的文件系统</p>
</td>
</tr>
<tr id="row1277055310150"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p2686337111816"><a name="p2686337111816"></a><a name="p2686337111816"></a>qemu-arm/zImage</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p9770135311518"><a name="p9770135311518"></a><a name="p9770135311518"></a>arm架构下支持qemu的内核镜像</p>
</td>
</tr>
<tr id="row1277055310150"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p2686337111816"><a name="p2686337111816"></a><a name="p2686337111816"></a>qemu-arm/initrd_tiny</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p9770135311518"><a name="p9770135311518"></a><a name="p9770135311518"></a>arm架构下极简文件系统</p>
</td>
</tr>
<tr id="row1277055310150"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p2686337111816"><a name="p2686337111816"></a><a name="p2686337111816"></a>qemu-arm/initrd</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p9770135311518"><a name="p9770135311518"></a><a name="p9770135311518"></a>arm架构下支持安全和容器的文件系统</p>
</td>
</tr>
<tr id="row1277055310150"><td class="cellrowborder" valign="top" width="31.509999999999998%" headers="mcps1.2.3.1.1 "><p id="p2686337111816"><a name="p2686337111816"></a><a name="p2686337111816"></a>source-list/manifest.xml</p>
</td>
<td class="cellrowborder" valign="top" width="68.49%" headers="mcps1.2.3.1.2 "><p id="p9770135311518"><a name="p9770135311518"></a><a name="p9770135311518"></a>嵌入式创新版使用的源码清单</p>
</td>
</tr>
</tbody>
</table>
...
<tr id="row16791828125815"><td class="cellrowborder" valign="top" width="28.000000000000004%" headers="mcps1.2.3.1.1 "><p id="p137919284589"><a name="p137919284589"></a><a name="p137919284589"></a><span id="ph9676303584"><a name="ph9676303584"></a><a name="ph9676303584"></a>edge_img</span></p>
</td>
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.2.3.1.2 "><p id="p479117286581"><a name="p479117286581"></a><a name="p479117286581"></a><span id="ph19963182719110"><a name="ph19963182719110"></a><a name="ph19963182719110"></a>存放边缘镜像</span></p>
</td>
</tr>
<tr id="row16791828125815"><td class="cellrowborder" valign="top" width="28.000000000000004%" headers="mcps1.2.3.1.1 "><p id="p137919284589"><a name="p137919284589"></a><a name="p137919284589"></a><span id="ph9676303584"><a name="ph9676303584"></a><a name="ph9676303584"></a>embedded_img</span></p>
</td>
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.2.3.1.2 "><p id="p479117286581"><a name="p479117286581"></a><a name="p479117286581"></a><span id="ph19963182719110"><a name="ph19963182719110"></a><a name="ph19963182719110"></a>存放嵌入式镜像</span></p>
</td>
</tr>
