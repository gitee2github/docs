...
<td class="cellrowborder" valign="top" width="68.33%" headers="mcps1.2.3.1.2 "><p id="p1069182871017"><a name="p1069182871017"></a><a name="p1069182871017"></a>暂停虚拟机的运行，使虚拟机处于paused状态</p>
</td>
</tr>
...
2.  为VNC创建证书和私钥文件。此处以GNU TLS为例进行说明。
    ...
    2.  为VNC服务端颁发证书。其中Server Organization Name为实际的服务名称，例如server.foo.com，需要用户根据实际指定。
