...
-   [StratoVirt用户指南]({{< relref "./docs/StratoVirt/StratoVirtGuide.md" >}})
    ...
    -   [最佳实践]({{< relref "./docs/StratoVirt/最佳实践.md" >}})
...
-   [第三方软件安装指南]({{< relref "./docs/thirdparty_migration/thidrparty.md" >}})
    -   [OpenStack安装指南]({{< relref "./docs/thirdparty_migration/openstack.md" >}})
        -   [安装OpenStack-queens]({{< relref "./docs/thirdparty_migration/OpenStack-queens.md" >}})
        -   [安装OpenStack-rocky]({{< relref "./docs/thirdparty_migration/OpenStack-rocky.md" >}})
        -   [使用devstack安装OpenStack-train]({{< relref "./docs/thirdparty_migration/openstack-train-devstack.md" >}})
    ...
    -   [HA 用户指南]({{< relref "./docs/desktop/ha.md" >}})
        -   [部署 HA]({{< relref "./docs/desktop/HA的安装与部署.md" >}})
        -   [HA 使用实例]({{< relref "./docs/desktop/HA的使用实例.md" >}})
